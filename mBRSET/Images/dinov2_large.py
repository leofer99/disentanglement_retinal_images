...
if __name__ == '__main__':
    ...
    if TASK=='2class_DR': #Divide into 2 DR classes:
        LABEL = 'final_icdr'
        num_classes = 2
    ...
    elif TASK=='3class_DR': #Divide into 3 DR classes:
        LABEL = 'final_icdr'
        num_classes=3
    ...
    #Train
    model, train_losses, val_losses = train(model, train_dataloader, val_dataloader, criterion, optimizer, num_epochs=num_epochs, save=True, device=device, num_classes=num_classes, backbone=f'{BACKBONE}_{num_classes}class_{LABEL}')


    # Save trained model:
    save_directory= os.path.join(parent_dir, 'mBRSET','Images',f'dinov_aug{augmentation}')
