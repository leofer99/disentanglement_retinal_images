...
filtered_patients_info['age'] = filtered_patients_info['age'].replace({'>= 90': 91}).astype(int)
...
th_age=50
filtered_patients_info['age']=filtered_patients_info['age'].apply(lambda x: 0 if x <= th_age else 1 ).astype(int)
...
correlation_matrix = filtered_patients_info[attributes_to_analyse].astype(float).corr()
