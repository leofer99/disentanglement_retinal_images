...
from configs import MBRSET_DIR1, MBRSET_DIR2, MODEL_CONFIG, ATTRIBUTES_TO_ANALYZE_MBRSET, SUBGROUP_METRICS, FAIRNESS_METRICS, EVAL_METRICS
...
Evaluation = EvaluationMetrics(df=df_, df_eval=df_eval, model_name=model_name, dataset='mBRSET', file_dir=file_dir)
