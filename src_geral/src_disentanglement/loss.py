...
# Loss Implementation
def compute_custom_loss(inputs, outputs, targets, weights, cce=None, bce=None):
    ''' 
    ...
    loss_feat_consistency - feature disentanglement 
    '''
    ...
    # print("target_id min:", target_id.min().item(), "max:", target_id.max().item(), "shape:", target_id.shape)
    # print("target_id.shape:", target_id.shape)
    # print("identity_out.shape:", id_out.shape)
