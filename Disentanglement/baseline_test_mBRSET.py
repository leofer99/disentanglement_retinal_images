...
from src_disentanglement.init_train_eval import initialize_models, load_model_baseline, evaluate_model_baseline, evaluate_identity_model
...
if __name__ == '__main__':
  ...
  # Define your hyperparameters
    ...
    # ============ Load Saved Model ============ #
    load_model_baseline(model_path, device, models)
    ...
    # Evaluation
    print("Train - Model: ")
    evaluate_model_baseline(models=models, dataloader=train_dataloader, device=device, df_train=df_train, save_path=save_dir)
    ...
    print("Test - Model: ")
    evaluate_model_baseline(models=models, dataloader=test_dataloader, device=device, df_test=df_test, save_path=save_dir)
