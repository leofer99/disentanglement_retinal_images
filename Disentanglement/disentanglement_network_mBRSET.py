...
from src_disentanglement.init_train_eval import initialize_models, setup_optimizers, train_one_epoch, evaluate_model, evaluate_model_val, evaluate_identity_model
...
if __name__ == '__main__':
    ...
    parser.add_argument('--id_info', type=str, required=False, default='age', help="Attribute to be disentangled.")
    parser.add_argument('--df_size', type=str, default='200', required=False, help="Size of the dataset.")
    ...
    #BALANCED LOSSES
    run_name = f"bal_aug{augmentation}_{model}_id_{str(id_info)}_Disen{disentanglement}_ld{latent_dim}_bs{batch_size}_lrG{learning_rate_gen}_DF{df_size}"
